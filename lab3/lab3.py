...
class DeepConvNet(nn.Module):
    def __init__(self, activation=None, deepconv=[25,50,100,200], dropout=0.55):
...
if __name__ == "__main__":
    ...
    Accs = runModels(models, epoch_size=300, batch_size=237, learning_rate=0.001, show=False)
    ...
    Accs = runModels(models, epoch_size=300, batch_size=237, learning_rate=1e-3, show=False)
